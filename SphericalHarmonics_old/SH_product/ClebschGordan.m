...
% 実行テスト
% 
% J=1,m= 1: ClebschGordan(1/2,1/2,1,1/2,1/2,1)
% J=1,m= 0: ClebschGordan(1/2,1/2,1,1/2,1/2,0)
% J=1,m=-1: ClebschGordan(1/2,1/2,1,1/2,1/2,-1)
% J=1,m= 1: ClebschGordan(1/2,1/2,0,1/2,1/2,0)
% 
% 球面調和関数で実際に成り立つかを確認できると嬉しい
% 
% 
...
% Reference: Clebsch-Gordan Coefficient entry of Eric Weinstein's Mathworld:
